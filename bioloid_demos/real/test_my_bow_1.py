...
class AllJointsTest(Node):
    def __init__(self):
        ...
        self.motion_steps = [
            [512] + [600] + [512]*17 + [512]*7 + [0.0, 3.0],     # Joint 1 only
            [512] + [512, 600] + [512]*16 + [512]*7 + [0.0, 3.0],  # Joint 2 only
            [512] + [512]*2 + [600] + [512]*15 + [512]*7 + [0.0, 3.0],  # Joint 3 only
            [512] + [512]*3 + [600] + [512]*14 + [512]*7 + [0.0, 3.0],
            [512] + [512]*4 + [600] + [512]*13 + [512]*7 + [0.0, 3.0],
            [512] + [512]*5 + [600] + [512]*12 + [512]*7 + [0.0, 3.0],
            [512] + [512]*6 + [600] + [512]*11 + [512]*7 + [0.0, 3.0],
            [512] + [512]*7 + [600] + [512]*10 + [512]*7 + [0.0, 3.0],
            [512] + [512]*8 + [600] + [512]*9  + [512]*7 + [0.0, 3.0],
            [512] + [512]*9 + [600] + [512]*8  + [512]*7 + [0.0, 3.0],
            [512] + [512]*10 + [600] + [512]*7 + [512]*7 + [0.0, 3.0],
            [512] + [512]*11 + [600] + [512]*6 + [512]*7 + [0.0, 3.0],
            [512] + [512]*12 + [600] + [512]*5 + [512]*7 + [0.0, 3.0],
            [512] + [512]*13 + [600] + [512]*4 + [512]*7 + [0.0, 3.0],
            [512] + [512]*14 + [600] + [512]*3 + [512]*7 + [0.0, 3.0],
            [512] + [512]*15 + [600] + [512]*2 + [512]*7 + [0.0, 3.0],
            [512] + [512]*16 + [600] + [512]   + [512]*7 + [0.0, 3.0],
            [512] + [512]*17 + [600]           + [512]*7 + [0.0, 3.0],  # Joint 18 only
        ]
